...
class FinanceController extends Controller
{
    public function summary(Request $request)
    {
        ...
        return response()->json([
            ...
            'ventasPorDia' => $this->salesGroupedByDay($desde, $hasta),
            'transacciones' => $this->detailedSales($desde, $hasta),
        ]);
    }

    private function salesGroupedByDay($desde, $hasta)
    {
        $query = DB::table('sales')
    ...
    private function detailedSales($desde, $hasta)
    {
        $query = DB::table('sales')
    ...
    public function historicalBalance(Request $request)
    {
        $desde = $request->input('desde');
        $hasta = $request->input('hasta');
