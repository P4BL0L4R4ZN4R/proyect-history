...
<h2>Estado de la Suscripcion de Laboratorios</h2>
                ...
                <tr>
                    ...
                    <td style="text-align: center; ">
                        ...
                        <div class="switch">
                            ...
                            <label class="switch-SUSCRIPCION" id="switchLabel-{{ $cfdi->id }}">
                                {{ $cfdi->SUSCRIPCION }}
                                <input type="checkbox" class="form-check-input switch-suscripcion"
                                    {{ $cfdi->SUSCRIPCION == 'ACTIVADO' ? 'checked' : '' }}
                                    value="{{ $cfdi->SUSCRIPCION }}"
                                    disabled> <!-- Asegúrate de que 'disabled' esté aquí para deshabilitar el switch -->
                                <span class="slider-SUSCRIPCION"></span>
                            </label>
                        </div>
                        <span class="tooltipSW bg-info">
                            Alternar entre activado<br>&nbsp;&nbsp;&nbsp;&nbsp;y<br>&nbsp;&nbsp;&nbsp;&nbsp;desactivado
                        </span>
                        <span class="text"></span>
                    ...
                    <td style="text-align: center; " class="bg-success text-white">{{$cfdi->SUSCRIPCION}}</td>
                    @elseif($cfdi->SUSCRIPCION == 'DESACTIVADO' ?? '')
                    <td style="text-align: center; " class="bg-danger text-white">{{$cfdi->SUSCRIPCION}}</td>
                    @else
