...
class EmailSupportButton extends StatelessWidget {
  static const String _email = 'soporte@rutvans.com';
  static const String _subject = 'Consulta sobre el servicio';

  const EmailSupportButton({super.key});
  ...
  Future<void> _sendEmail(BuildContext context) async {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.email, size: 40, color: ConstantColors.colorIcon),
              ),
    ...
    if (confirm == true) {
      ...
      final Uri emailUri = Uri.parse('mailto:$_email?subject=$encodedSubject');
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        backgroundColor: ConstantColors.colorButtonBackground3,
